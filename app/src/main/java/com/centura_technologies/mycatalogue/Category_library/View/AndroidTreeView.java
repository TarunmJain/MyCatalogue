package com.centura_technologies.mycatalogue.Category_library.View;
...
import com.centura_technologies.mycatalogue.Category_library.Holder.SimpleViewHolder;
        ...
        nodeView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(n.getChildren().size()==0)
                {
                    ...
                    IconTreeItemHolder.IconTreeItem abc=(IconTreeItemHolder.IconTreeItem)temp;
                    Toast.makeText(mContext, abc.id, Toast.LENGTH_SHORT).show();
                }
                else {
